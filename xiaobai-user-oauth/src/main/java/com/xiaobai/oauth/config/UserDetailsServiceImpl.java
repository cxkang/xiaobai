package com.xiaobai.oauth.config;

import com.xiaobai.oauth.util.UserJwt;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        Result<TUser> userResult = userFeign.findById(username);
        ...
        String pwd = userResult.getData().getClientPassword();
        //创建User对象
